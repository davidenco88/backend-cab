...
async function main() {
  ...
  await prisma.vehicleTypes.createMany({
    data: [
      { name: "Spacious vehicle", seats: 5 , luggage:"25 lts", isActive: true,  feeBase: 120  },
      { name: "Luxury vehicle", seats: 3 , luggage:"25 lts", isActive: true,  feeBase: 150 },
      { name: "Economic vehicle", seats: 4 , luggage:"10 lts", isActive: true, feeBase: 80 },
    ],
    skipDuplicates: true,
  });
